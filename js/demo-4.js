...
var demo = (function(window, undefined) {
  ...
  function _bindCards() {
    ...
    $.each(elements, function(card, i) {
      ...
      // $(cardImage).on('mouseover', _playSequence.bind(this, true, i));
      // $(cardImage).load(_playSequence.bind(this, true, i))
      $(cardImage).on('load',_playSequence.bind(this, true, i));
  ...
  function _setPatternBgImg(image) {
    ...
    $(SELECTORS.pattern).css('background-image', 'url(./images/bg.jpg)');
  };
